...
import { FiLogOut, FiChevronDown, FiPhone, FiBriefcase } from "react-icons/fi";
import {
  LuLayoutDashboard,
  LuClipboardList,
  LuFileQuestion,
 ...
 * Rich indigo/sky menu with quick navigation to the AI tools, the current
 * route highlighted, plus the user's identity and sign out.
    ...
    <div ref={containerRef} className="relative">
      ...
      {open && (
        ...
        >
          ...
          {/* Navigation */}
          <div className="p-1.5 hidden">
            <p className="px-2.5 pb-1 pt-2 text-[11px] font-semibold uppercase tracking-wider text-slate-400">
              Menu
            </p>
            {MENU_LINKS.map((link) => {
                ...
                >
                  <span
                    className={`flex h-9 w-9 shrink-0 items-center justify-center rounded-lg transition ${
                      active
                        ? "bg-gradient-to-br from-indigo-600 to-sky-500 text-white shadow-md shadow-indigo-500/30"
